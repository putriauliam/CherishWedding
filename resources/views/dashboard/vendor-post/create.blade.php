    ...
    <form class="w-sm mx-auto" method="post" action="/dataVendor" enctype="multipart/form-data">
        ...
        <div class="mb-2">
            ...
            <input type="text" id="name" name="name"
                ...
                placeholder="Nama Vendor" autofocus  value="{{ old('name') }}">
            @error('name')
        ...
        <div class="flex justify-center">
            <button type="submit"
                class="w-52 text-white bg-red-500 border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 mt-3 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Tambah Data</button>
        </div>
    </form>
