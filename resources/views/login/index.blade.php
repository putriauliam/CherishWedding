...
<body class="h-screen overflow-hidden">
    <div class="bg-cover bg-center h-screen" style="background-image: url('img/banner.jpg');">
        <div class="flex justify-center rounded-3xl">
            <div
                class="block max-w-sm p-6 bg-white bg-opacity-80 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-96 mt-20">
                ...
                <form action="/login" method="post" class="max-w-sm mx-auto">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="email" name="email" id="email"
                            ...
                            placeholder="nama@gmail.com" autofocus required value="{{ old('email') }}">
                        @error('email')
                    ...
                    <div class="flex flex-col justify-center items-center">
                        ...
                        <p class="">Belum punya akun? <a href="/daftar" class="text-blue-700">Daftar</a></p>
                        <p class="py-1.5">Atau login dengan</p>
