...
<section class="bg-center bg-no-repeat bg-blend-multiply" style="background-image: url('/img/wedding1.jpg');">
  ...
  <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
    ...
    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48">Temukan pengalaman pernikahan tak terlupakan dengan venue elegan kami. Dapatkan harga terbaik untuk momen abadi Anda. Kunjungi situs Cherish Wedding sekarang untuk pernikahan impian Anda!</p>
