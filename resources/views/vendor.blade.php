            ...
            @foreach($vendor as $v)
                <div class="card w-44 bg-gray-200 mb-3 mr-2 relative block ">
                    ...
                    @if($v->image)
                        ...
                        @else
                        <img class="p-3 rounded-t-lg" src='https://source.unsplash.com/500x500/?{{ $v->category->name }}'
                        alt="makeup image" />
                        @endif
                    ...
                    <div class="mt-2 mb-4">
                        <p class="px-2 flex text-xs font-hard font-thin dark:text-white">{{ $v->category->name }}
                        </p>
                        <p class="px-2 flex text-xs font-medium font-thin dark:text-white">{{ $v->city->name }}</p>
                    </div>
                </div>
            @endforeach
        </div>
