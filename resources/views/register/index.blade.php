        ...
        <div class="flex justify-center rounded-3xl">
            <div
                ...
                <form class="max-w-sm mx-auto" action="/daftar" method="post">
                    ...
                    <div class="mb-2">
                        <label for="username" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Nama
                            Pengguna</label>
                        <input type="text" id="username" name="username"
                            ...
                            placeholder="Nama" required value="{{ old('username') }}">
                        @error('username')
                            <p class="invalid-feedback mt-2 text-sm text-red-600 dark:text-red-500">
                                {{ $message }}
                            </p>
                    ...
                    <div class="mb-2">
                        <label for="password" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Kata
                            Sandi</label>
                ...
                <p class="">Sudah punya akun? <a href="/login" class="text-blue-700">Masuk</a></p>
                <p class="py-1.5">Atau Daftar Dengan</p>
                <a href="{{ route('auth.google') }}"><img class="w-16" src="img/google.png"
                        alt=""></a>
            </div>
        </div>
    </div>
