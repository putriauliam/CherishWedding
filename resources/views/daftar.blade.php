...
<div class="bg-cover bg-center h-screen" style="background-image: url('img/banner.jpg');"> 
  <div class="flex justify-center rounded-3xl">
    <div class="block max-w-sm p-6 bg-white bg-opacity-80 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-96 mt-6">
